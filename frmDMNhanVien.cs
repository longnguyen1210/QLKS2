...
namespace QLKS2
{
    public partial class frmDMNhanVien : Form
    {
        ...
        private void LoadDataGridView()//SELECT ́ GIAOVIEN
        {
            ...
            //dgvNhanVien.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells; //Tự động điều chỉnh kích thước cột
            dgvNhanVien.EditMode = DataGridViewEditMode.EditProgrammatically; //Không cho phép chỉnh sửa trực tiếp trên DataGridView
        ...
        {
            Application.Exit(); // Đóng toàn bộ ứng dụng khi form này đóng
        }
    }
}
